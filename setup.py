...
setup(
    ...
    long_description='bonAPIty is the simplest python3 package allowing you to create API for your functions without writing any complicated line of server code ! See more [here](https://vievie31.github.io/bonapity/) !',
